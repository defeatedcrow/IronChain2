...
@Mod(
		...
		name = "DCsIronChain2",
		version = "1.7.10_2.0f",
		dependencies = "required-after:Forge@[10.13.2.1230,);after:BuildCraft|Core"
		)
...
public class DCsIronChain{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		ironChain = (new BlockIronChain()).
				setBlockName("defeatedcrow.ironChain").
				setCreativeTab(ironchainTab);
		
		anchorBolt = (new BlockAnchorBolt()).
				setBlockName("defeatedcrow.anchorBolt").
				setCreativeTab(ironchainTab);
		
		kyatatu = (new BlockKyatatu()).
				setBlockName("defeatedcrow.kyatatu").
				setCreativeTab(ironchainTab);
		
		floodLight = (new BlockFloodLight()).
				setBlockName("defeatedcrow.floodlight").
				setCreativeTab(ironchainTab);
		
		DCLightPart = (new BlockLightPart()).
				setBlockName("defeatedcrow.lightBlock");
		
		RHopper = (new BlockRHopper()).
				setBlockName("defeatedcrow.reversalHopper").
				setCreativeTab(ironchainTab);
		
		RHopperGold = (new BlockRHopperGold(true)).
				setBlockName("defeatedcrow.reversalHopper_gold").
				setCreativeTab(ironchainTab);
		
		hopperGold = (new BlockRHopperGold(false)).
				setBlockName("defeatedcrow.positiveHopper_gold").
				setCreativeTab(ironchainTab);
		
		RHopperBlack = (new BlockRHopperBlack(true)).
				setBlockName("defeatedcrow.reversalHopper_black").
				setCreativeTab(ironchainTab);
		
		hopperBlack = (new BlockRHopperBlack(false)).
				setBlockName("defeatedcrow.positiveHopper_black").
				setCreativeTab(ironchainTab);
		...
		anzenMet = (new ItemAnzenArmor(ItemArmor.ArmorMaterial.CHAIN, DCsIronChain.proxy.addArmor("anzenarmor"), 0)).
				...
				setCreativeTab(ironchainTab).setTextureName("dcironchain:anzen_met");
		...
		sagyougi = (new ItemAnzenArmor(ItemArmor.ArmorMaterial.CHAIN, DCsIronChain.proxy.addArmor("anzenarmor"), 1)).
				...
				setCreativeTab(ironchainTab).setTextureName("dcironchain:sagyougi");
		...
		anzenBoots = (new ItemAnzenArmor(ItemArmor.ArmorMaterial.CHAIN, DCsIronChain.proxy.addArmor("anzenarmor"), 3)).
				...
				setCreativeTab(ironchainTab).setTextureName("dcironchain:anzen_boots");

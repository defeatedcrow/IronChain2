	...
	public void addRecipe() {
      ...
      GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"XYX","XYX","XYX",
	    			  ...
	    			  Character.valueOf('Y'), Blocks.ladder}));
      ...
      GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"XXX","ZYZ"," X ",
	    			  ...
	    			  Character.valueOf('Z'), Blocks.iron_bars}));
      ...
      GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"XYX","ZWZ",
	    			  ...
	    			  Character.valueOf('Y'), Items.leather_helmet,
	    			  Character.valueOf('Z'), Items.string,
      ...
      GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"X X","XXX","YYY",
	    			  Character.valueOf('X'), new ItemStack(Blocks.wool, 1, 9),
      ...
      GameRegistry.addRecipe(
    		  ...
    		  new Object[]{" X ","XZX","XYX",
    			  ...
    			  Character.valueOf('Z'), Blocks.dropper
    			  }));
      ...
      GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"XXX","ZYZ"," X ",
	    			  Character.valueOf('X'), "ingotBronze",
	    			  Character.valueOf('Y'), Blocks.glowstone,
	    			  Character.valueOf('Z'), Blocks.fence}));
      ...
      if (DCsIronChain.bronzeRecipe)
      {
    	  ...
    	  GameRegistry.addRecipe(
 				 new ShapedOreRecipe(
 	    		  ...
 	    		  new Object[]{"X X","XYX"," X ",
 	    			  Character.valueOf('X'), "ingotBronze",
 	    			  Character.valueOf('Y'), Blocks.chest}));
       
          GameRegistry.addRecipe(
 				 new ShapedOreRecipe(
 	    		  new ItemStack(Blocks.piston, 1),
 	    		  new Object[]{"YYY","ZXZ","ZWZ",
 	    			  Character.valueOf('X'), "ingotBronze",
 	    			  Character.valueOf('Y'), "plankWood",
 	    			  Character.valueOf('Z'), Items.redstone,
 	    			  Character.valueOf('W'), "cobbleStone"}));
      }

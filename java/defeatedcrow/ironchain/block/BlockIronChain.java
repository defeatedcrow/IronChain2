...
public class BlockIronChain extends Block {
	...
	public IIcon getIcon(int side, int meta) {
		...
		return side == 1 ? this.blockIcon : this.chainIcon[meta];
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.chainIcon = new IIcon[3];
		for (int i = 0; i < 3; i++) {
			this.chainIcon[i] = par1IconRegister.registerIcon("dcironchain:chain" + i);
		}
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5) {
		...
		if ((par1World.getBlock(par2, par3 + 1, par4) != DCsIronChain.ironChain)
				&& (par1World.getBlock(par2, par3 + 1, par4) != DCsIronChain.anchorBolt)
				&& !par1World.isSideSolid(par2, par3 + 1, par4, dir)) {
	...
	public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
		ForgeDirection dir = ForgeDirection.DOWN;
		if (par1World.isAirBlock(par2, par3 + 1, par4) || par1World.getBlock(par2, par3 + 1, par4) == null)
			return false;
		return ((par1World.getBlock(par2, par3 + 1, par4) == DCsIronChain.ironChain)
				|| (par1World.getBlock(par2, par3 + 1, par4) == DCsIronChain.anchorBolt) || par1World
					.isSideSolid(par2, par3 + 1, par4, dir));
	}

...
public class BlockKyatatu extends Block{
	...
	{
		int m = metadata;
		if (m < 2) return Item.getItemFromBlock(this);
		else return null;
	}
    ...
    {
        return par3 >= 254 ? false : par1World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4) && par1World.isAirBlock(par2, par3 + 1, par4) && par1World.isAirBlock(par2, par3 + 2, par4);
    }
